...
import com.eatitappclient.tws.Callback.MyButtonClickListener;
...
public abstract class MySwipHelper extends ItemTouchHelper.SimpleCallback {
    ...
    private View.OnTouchListener onTouchListener = (View.OnTouchListener) (view, motionEvent) -> {
        try {
            ...
            View swipeItem = swipViewHolder.itemView;
            Rect rect = new Rect();
    ...
    public MySwipHelper(Context context,RecyclerView recyclerView,int buttonWidth)
    {
