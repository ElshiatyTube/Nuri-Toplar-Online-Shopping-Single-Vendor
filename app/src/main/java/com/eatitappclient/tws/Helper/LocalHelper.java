package com.eatitappclient.tws.Helper;
...
public class LocalHelper {
    ...
    public static Context onAttach(Context context, String defultLanugae) {
        String lang = getPersistedData(context, defultLanugae);
        return setLocale(context, lang);
    }
